...
| **3 — Feature Engineering** | 3.1 ✅ (spec SIGNED v1.1) 3.2 ✅ 3.3 ✅ 3.5 ✅ 3.6 ✅ · Open: 3.4 (feature QA: distributions, correlations, RV-variant decision) + mandatory leakage-redteam review of the feature code → Gate 3. Master table: 847k rows × 28 features, harness green. |
| **4–6** | Not started. |
