...
| **1 — Grid, Baseline & Validation** | 1.1 ✅ 1.2 ✅ 1.3 ✅ (`quant/` + `analysis/delta_mapping.py`, all math-verifier VERIFIED; calibration record in `docs/calibration.md`) · Open: 1.4 (baseline validation vs chains), 1.5 (grid coverage), 1.6 (exit characterization), 1.7 (sensitivity memo). |
