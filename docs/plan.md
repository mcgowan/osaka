...
| **1 — Grid, Baseline & Validation** | 1.1–1.5 ✅ (all math-verifier VERIFIED; calibration record in `docs/calibration.md`; baseline = f(t)-corrected `quant.pmkt.p_mkt()`, grid coverage PASS 98.7%/97.9%) · Open: 1.6 (exit characterization), 1.7 (sensitivity memo), then Gate 1 review. |
