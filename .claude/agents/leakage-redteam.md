...
Project context: CLAUDE.md, docs/spx-0dte-survival-model-requirements.md (NFR-1 is your charter).
...
6. **Configuration attack.** Frozen constants (m_put, m_call, δ*) must come from Phase-1 calibration config, not be re-derived from data inside feature or training code.
